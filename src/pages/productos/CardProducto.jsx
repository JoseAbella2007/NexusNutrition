  ...
  return (
    <>
      <div
        ...
        onClick={() => setMostrarQuickView(true)}
      >
        <img
          src={producto.imagen}
          alt={producto.nombre}
        ...
        <div className="card-producto__superior">
          <span className="card-producto__categoria">
            {producto.categoria}
          </span>
          ...
          <div className="card-producto__iconos">
            <button
              className={`card-producto__icono-boton ${
                agregado
                  ? 'card-producto__icono-boton--activo'
                  : ''
              }`}
        ...
        <div className="card-producto__panel">
          <h3 className="card-producto__nombre">
            {producto.nombre}
          </h3>
      ...
      {mostrarQuickView && (
        <QuickViewProducto
          producto={producto}
          onCerrar={() => setMostrarQuickView(false)}
        />
      )}
    </>
  );
